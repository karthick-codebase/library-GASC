                          ...
                          : genre.includes("Math")
                            ...
                            : genre.includes("Phys")
                              ...
                              : genre.includes("Chem")
                                ...
                                : genre.includes("Bot")
                                  ? "🌿"
                                  : genre.includes("English")
                                    ? "🔤"
                                    : genre.includes("Tamil")
                                      ? "📜"
                                      : genre.includes("BBA")
                                        ? "💼"
                                        : genre.includes("B.Com")
                                          ? "📊"
                                          : "📚"}
                      </div>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">
                      ...
                      {stats.totalBooks} books across {stats.totalGenres} genres
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-500 mr-3">✓</span>
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl shadow-lg p-6 border-t-4 border-purple-500">
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center justify-between">
                    <span className="text-gray-700">Most Popular Genre:</span>
                    <span className="font-bold text-purple-600">
